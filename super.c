...
try_onemore:
	...
	/*1. allocate memory for f2fs-specific super block info */
	...
	/* 7.disallow all the data/node/meta page writes，禁止所有data/node/meta page写入 */
	set_sbi_flag(sbi, SBI_POR_DOING);
	spin_lock_init(&sbi->stat_lock);

	/* 8. init iostat info，初始化Io状态锁 */
	spin_lock_init(&sbi->iostat_lock);
	sbi->iostat_enable = false;

	/* 9. 分配write_io空间
	// data: sbi->write_io[0] = 3个f2fs_bio_info，冷温热，初始化其中的sbi, bio,io_lock, io_list
	// node: .............[1]...........................................
	// meta: .............[2] = 1个，热
	*/
	for (i = 0; i < NR_PAGE_TYPE; i++) {
...
/*
	...
	int aret = tgt_mapping_erase(sbi, 545,1);
	mdelay(5000);
